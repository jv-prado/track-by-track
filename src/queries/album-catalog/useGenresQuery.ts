...
// Curada no backend — Spotify descontinuou o endpoint dinâmico de gêneros
// (ver api/src/modules/album-catalog/genres.constant.ts). Muda raramente:
// staleTime longo evita bater na API toda vez que o filtro abre.
